...
class FavFilms extends StatefulWidget {
  FavFilms({super.key});

  @override
  State<FavFilms> createState() => _FavFilmsState();
}

class _FavFilmsState extends State<FavFilms> {
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                      ...
                      child: FilmsList(onlyFavourites: true, search: _searchController.text,)),
                  ),
              ],
            ),
          );
